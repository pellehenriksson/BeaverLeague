                ...
                return React.createElement("tr", { key: m.id },
                    React.createElement("td", null,
                        React.createElement("span", { className: "pull-right" },
                            React.createElement("a", { href: "#", title: "Remove match", onClick: function () { return props.deleteMatch(m.id); } },
...
var EditMatchSet = (function (_super) {
    ...
    EditMatchSet.prototype.render = function () {
        ...
        return (React.createElement(react_bootstrap_1.Grid, { fluid: true },
            ...
            React.createElement(react_bootstrap_1.Row, null,
                ...
                React.createElement(react_bootstrap_1.Col, { sm: 4 },
                    React.createElement(MatchList, { matches: state.matchset.matches, deleteMatch: function (id) { return store.deleteMatch(id); } })),
                React.createElement(react_bootstrap_1.Col, { sm: 4 },
