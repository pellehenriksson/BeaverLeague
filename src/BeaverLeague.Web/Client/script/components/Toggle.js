...
var Toggle = (function (_super) {
    ...
    Toggle.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: 'switcher', disabled: this.props.disabled, className: this.state.active ? activeClass : inactiveClass, onClick: this.onClick.bind(this), style: style },
